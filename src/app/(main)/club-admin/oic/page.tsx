  ...
  return (
    <div className="space-y-6">
      <Card className="shadow-lg">
        ...
        <CardContent>
          <p className="text-muted-foreground">This page will enable Club Admins to create, read, update, and delete OIC users specifically for their club and assign them to club events.</p>
          <div className="mt-6 p-8 border-2 border-dashed border-border rounded-lg text-center">
            <p className="text-lg font-medium text-muted-foreground">No OICs found for your club.</p>
          </div>
        </CardContent>
      </Card>
    </div>
